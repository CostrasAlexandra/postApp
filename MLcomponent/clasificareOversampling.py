...
print("________")
data_1_resampling = resample(data_1,replace=True, n_samples=93, random_state=90)
data_2_resampling = resample(data_2,replace=True, n_samples=93, random_state=90)
data_3_resampling = resample(data_3,replace=True, n_samples=93, random_state=90)
data_4_resampling = resample(data_4,replace=True, n_samples=93, random_state=90)
